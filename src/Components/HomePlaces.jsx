...
function HomePlaces() {
    return (
        <div>
            <Row className='gx-0'>
                <Col md={6} style={{ backgroundColor: "#23b3b4" }} className='d-flex justify-content-center p-4'>
                    <div style={{ width: "70%" }}>
                        ...
                        <div className='mb-3'>
                            <div className='d-flex align-items-center p-3 shadow rounded' style={{backgroundColor:"#e0e0e0"}}>
                                <div style={{ borderRadius: "50%", backgroundColor: "#b1b1b1"}} className='me-2 p-2'>
                                    <MdFlightTakeoff style={{ fontSize: "30px" }}  />
                                </div>
                                <div>
                                    <h5 className='mb-0'>Calicut International Airport</h5>
                                    <p className='mb-0' style={{fontSize:"11px"}}>Approximate Travel Time : 45 min</p>
                                </div>
                            </div>
                        </div>
                        <div className='mb-3'>
                            <div className='d-flex align-items-center p-3 shadow rounded' style={{backgroundColor:"#e0e0e0"}}>
                                ...
                                <div>
                                    <h5 className='mb-0'>Beypore Port</h5>
                                    <p className='mb-0' style={{fontSize:"11px"}}>Approximate Travel Time : 22 min</p>
                                </div>
                            </div>
                        </div>
                        <div className='mb-3'>
                            <div className='d-flex align-items-center p-3  shadow rounded' style={{backgroundColor:"#e0e0e0"}}>
                                ...
                                <div>
                                    <h5 className='mb-0'>Kozhikode Railway station</h5>
                                    <p className='mb-0' style={{fontSize:"11px"}}>Approximate Travel Time : 11 min</p>
                                </div>
                            </div>
                        </div>
                        <div className='mb-3'>
                            <div className='d-flex align-items-center p-3  shadow rounded' style={{backgroundColor:"#e0e0e0"}}>
                                ...
                                <div>
                                    <h5 className='mb-0'>Kozhikode New Busstand</h5>
                                    <p className='mb-0' style={{fontSize:"11px"}}>Approximate Travel Time : 8 min</p>
                                </div>
                            </div>
                        </div>
                    </div>
